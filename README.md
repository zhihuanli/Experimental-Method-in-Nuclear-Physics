...
1. 离子源与束流产生
2. 静电加速器、回旋加速器、直线加速器与同步加速器
3. 束流光学：磁刚度、偶极磁铁、四极磁铁与传输矩阵
4. 放射性离子束：in-flight、ISOL 与磁分离器
5. 加速器应用：中子源、对撞机与同步辐射

## 教学安排

PKU 课程为 64 学时，UCAS 课程为 48 学时。各章学时、上课时间和考核方式见[课程安排](Syllabus.md)。
